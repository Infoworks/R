...
InitSpark <- function(sparkMaster = 'local', hdfs_url = "hdfs://ip-172-30-0-110.ec2.internal:8020") {
  #------ spark initialize ----

  # Set this to where Spark is installed
  # SKH Commented Sys.setenv(SPARK_HOME="/home/rstudio/spark/spark-1.5.1-bin-hadoop2.6")
...
Init <- function(db="infoworks-new", host="localhost", port='27017', username='infoworks', password='IN11**rk',
                 sparkMaster = 'local', hdfs_url = "hdfs://ip-172-30-0-110.ec2.internal:8020") {

  InitMongo(db="infoworks-new", host="localhost", port='27017', username='infoworks', password='IN11**rk')
  InitSpark(sparkMaster = 'local', hdfs_url = "hdfs://ip-172-30-0-110.ec2.internal:8020")
}
